        ...
        <div className="bg-black">
          <div className="bg-black h-screen">
            <div className="flex flex-col justify-center px-8 bg-black">
              ...
              <nav className='flex justify-end'><a className="text-slate-800 hover:text-slate-600 font-medium transition-colors duration-200" href='/blog'>/ blog</a></nav>
                <h1 className="text-5xl font-bold text-white">Hello! 👋</h1>
                <h1 className="text-5xl font-bold text-white">I'm Jake Swinford</h1>
                ...
                <div className="text-md text-slate-200 mt-8 mb-8">
                  <p className="text-base leading-relaxed mt-5 mb-5">
                    Glad, you made it here! I'm currently a Software Engineer based out of Idaho. 🇺🇸
                  </p>
                  <p className="text-base leading-relaxed mt-5 mb-5">
                  ...
                  <p className="text-base leading-relaxed mt-5 mb-5">
                    While attending the University of Texas at Arlington, I pursued a Bachelor of Science
                    degree in Physics with a minor in Mathematics. Additionally, I served as an
                    undergraduate research assistant with the COHE (Complex Oxides Heterostructures and
                    Electronics) group. During that time I developed a probe for testing samples immersed in
                    liquid nitrogen.
                  </p>
                  <p className="text-base leading-relaxed mt-5 mb-5">
                    Some of my hobbies outside of work include going to the gym, playing video games, and
                    getting into snowboarding during the winter months.
                  </p>
